...
export default function Uploader_pdf_img(props: UploaderProps){
    ...
    return (
        <div className="w-full h-full flex justify-end items-center relative " >
            <form className="flex " action="">
                <div className={`m-auto left-0 top-0 right-0 bottom-0 w-full h-6 ${props.className} border-zinc-500 border-dashed border-2 absolute flex items-center justify-center`}>
                ...
                <input className={`flex flex-col justify-center items-center border-2 border-dashed absolute z-0
                 border-zinc-300 m-auto top-0 left-0 bottom-0 right-0 w-28 h-10 rounded-md opacity-0`} type="file" accept="image/*, .pdf"
